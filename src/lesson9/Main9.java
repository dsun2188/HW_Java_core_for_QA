...
//    3. Написать функцию, принимающую на вход список Student и экземпляр Course, возвращающую список студентов, которые посещают этот курс.
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("Bob", Arrays.asList(new Course("Math"), new Course("Biology"),
                new Course("Testing"))));
        students.add(new Student("Artur", Arrays.asList(new Course("Math"), new Course("Geography"),
